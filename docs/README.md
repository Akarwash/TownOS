...
| [reference/syscalls.md](reference/syscalls.md) | The `int 0x50` syscall gate: the single DPL 3 doorway, the register calling convention, the eleven calls, and the untrusted-pointer checks |
